...
@section('content')
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Campaigns <a href="{{ route('campaigns.show_create_form') }}"><button class="btn btn-primary">Add New</button></a></h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
                    ...
                    <table width="100%" class="table table-striped table-bordered table-hover" id="datatable">
                        ...
                        @foreach($campaigns as $campaign)
                            <tr>
                                ...
                                <td><a href="campaigns/{{ $campaign->id }}/update"><button class="btn btn-primary">Modify</button></a></td>
                            </tr>
                        @endforeach
                        </tbody>
                    </table>
